...
public class Main {
    ...
    static Scanner s;
    static Functionalities database;

    public static void main(String[] args) {
        database = new Functionalities();

        JFrame frame = frame(500, 320);
        ...
        JLabel title = label("CUI LIBRARY SYSTEM");
    ...
    private static void newuser() {
        ...
        // Add the image
        ImageIcon libraryIcon = new ImageIcon("COMSATSogo.jpg");
	...
	public static JFrame frame(int width, int height) {
		...
		frame.setTitle("CUI LIBRARY SYSTEM");
